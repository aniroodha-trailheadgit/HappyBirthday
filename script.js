...
function setupScrollAnimations ()
  ...
  function createFloatingHeart(button)
    ...
    heart.animate(
        [
            {transfrom: 'translateY(0px) scale(1)', opacity:1},
            {transfrom: 'translateY(-60px) scale(1.5)', opacity:0}
        ],
        {
            duration:1500,
            easing: 'ease-out'
 ...
 window.addEventListener('scroll',()=> 
    {
      ...
      if(hero)
        {
            hero.style.transfrom = `translateY(${scrolled * parallaxSpeed}px)`;
        } 
      ...
      particles.forEach((particle,index) => 
        {
          ...
          particle.style.transfrom = `translateY(${scrolled * speed}px)`;  
        });
    });
 ...
 document.addEventListener('mousemove',(e) => {
    ...
    if(floatingHearts)
    {
        floatingHearts.style.transfrom = `translate(${moveX}px, ${moveY}px)`;
    }
  });
